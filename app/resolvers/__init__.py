from app.resolvers.instructor import get_instructors, get_instructor, create_instructor, delete_instructor
from app.resolvers.student import get_students, get_student, create_student, delete_student
